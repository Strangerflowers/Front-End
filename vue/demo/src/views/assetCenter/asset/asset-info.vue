  ...
  <div class="animated fadeIn col-lg-10-paddingleft0">
    ...
    <b-card>
      <b-form class="inline-form-col-6"  inline  v-on:reset.prevent="onReset" novalidate>
        ...
        <b-form-group  label-align="right"    label-cols-sm="5" label="资产种类：" label-class="require-input" id="inputGroupAssetType"    label-for="assetType">
        ...
        <template v-if="isBuilding" >
          ...
          <b-form-group  label-align="right"    label-cols-sm="5" label="管理团队：" label-class="require-input" id="manageTeamGroup"    label-for="manageTeam">
            <b-form-input  id="manageTeam"  type="text"  v-model="buildingForm.manageTeamName"  plaintext   />
          </b-form-group>

          <b-form-group  label-align="right"    label-cols-sm="5" label="经营公司：" label-class="require-input" id="managementCompanyGroup"    label-for="managementCompany">
            <b-form-input  id="managementCompany"  type="text"  v-model="buildingForm.managementCompanyName"  plaintext   />
          </b-form-group>
        ...
        <b-tabs class="col-12 tab-list" v-show="isUnit">
          <b-tab title="单元合同" active>
             <!--table表格组件-->

                <c-table class="over-scroll" hover striped bordered :busy.sync="isBusyUnit" :table-data="tableDataUnit" :fields="fieldsUnit" :showPage ="false">
                </c-table>
                <!--/table表格组件-->             
          </b-tab>
          <b-tab title="历史变更单元" >
               <!--table表格组件-->
                ...
                <c-table class="over-scroll" hover striped bordered  :busy.sync="isBusyUnitHistory"  :table-data="tableDataUnitHistory" :fields="fieldsUnitHistory" :showPage ="false">
                </c-table>
                <!--/table表格组件-->  
          </b-tab>          
        </b-tabs>
            ...
            .then(res=>{
              if (res.data.code === 0) {
                ...
                if(this.form.assetType!=undefined && this.form.assetType=="project"){
                  ...
                  this.tableDataUnitHistory=res.data.result.assetHistories;
